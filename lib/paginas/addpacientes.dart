...
//    //log"VIA CEP CIDADE ${result['city']}");
//    //log"VIA CEP CEP ${result['cep']}");
//    //log"VIA CEP BAIRRO ${result['neighborhood']}");
//    //log"VIA CEP ESTADO ${result['state']}");
  }
}
...
AppBar _appBar(String texto, bool aviso) {
  return AppBar(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: kFontLight.withOpacity(0.6), width: 2),
              borderRadius: BorderRadius.circular(
                8,
              ),
            ),
            child: Image.asset('assets/imagens/notification.png'),
            width: 30,
            height: 30,
          ),
          Positioned(
...
final snackBar = SnackBar(content: const Text('indo'),

 _scaffoldKey.currenyState!.ShowSnackBar(snackBar)
